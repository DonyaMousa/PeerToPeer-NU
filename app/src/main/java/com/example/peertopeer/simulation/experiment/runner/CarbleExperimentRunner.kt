...
class CarbleExperimentRunner(
    ...
    data class RunOutput(
        ...
        /*
         * Event-level CARBLE regime/controller evidence.
         *
         * Used for pre-failure timeline reconstruction.
         */
        val regimeEvents:
        List<CarbleRegimeEventRecord>,

        /*
         * CARBLE-specific adaptation evidence.
         *
         * Kept separate from the common RunSummary so
         * B0/MM/2RH experiment schemas remain frozen.
         */
        val adaptation:
    ...
    /*
     * -----------------------------------------------------
     * MM observation parameters inherited by CARBLE HIGH
     * -----------------------------------------------------
     *
     * These remain identical to frozen MM-v1.0 and 2RH.
     */
    ...
    fun runSeededRetryScenario(
        ...
        require(
            ...
            "CARBLE S01 requires at least 2 nodes."
        }
        ...
        val successProbability =
            requireNotNull(
                ...
                "CARBLE S01 requires link.successProbability."
            }
        ...
        /*
         * EXACT SAME S01 stochastic stream as B0/MM/2RH.
         */
        val random =
            Random(
                config.seed
    ...
    fun runSeededTopologyScenario(
        ...
        require(
            ...
            "CARBLE S02 requires exactly 5 nodes."
        }
        ...
        val failureProbability =
            requireNotNull(
                ...
                "CARBLE S02 requires topologyFailureProbability."
            }
        ...
        require(
            ...
            "CARBLE S02 requires topologyDecisionTimes."
        }
        ...
        /*
         * EXACT SAME S02 topology RNG as B0/MM/2RH.
         */
        val topologyRandom =
            Random(
                config.seed
    ...
    fun runSeededCongestionScenario(
        ...
        require(
            ...
            "CARBLE S03 requires at least 2 nodes."
        }

        requireNotNull(
            config.traffic.burstProbability
        ) {
            "CARBLE S03 requires burstProbability."
        }

        requireNotNull(
            config.traffic.burstSize
        ) {
            "CARBLE S03 requires burstSize."
        }

        requireNotNull(
            config.traffic.burstSpacing
        ) {
            "CARBLE S03 requires burstSpacing."
        }
        ...
        /*
         * Perfect links exactly like B0/MM/2RH S03.
         */
        val transmitter =
            EventDrivenRetryLinkTransmitter(
        ...
        /*
         * EXACT SAME S03 traffic RNG as B0/MM/2RH.
         */
        val trafficRandom =
            Random(
                config.seed +
    ...
    fun runSeededReliabilityTopologyScenario(
        ...
        require(
            ...
            "CARBLE S04 requires exactly 5 nodes."
        }
        ...
        val successProbability =
            requireNotNull(
                ...
                "CARBLE S04 requires link.successProbability."
            }
        ...
        val failureProbability =
            requireNotNull(
                ...
                "CARBLE S04 requires topologyFailureProbability."
            }
        ...
        require(
            ...
            "CARBLE S04 requires topologyDecisionTimes."
        }
        ...
        /*
         * EXACT SAME S04 link RNG as B0/MM/2RH.
         */
        val linkRandom =
            Random(
                config.seed +
        ...
        /*
         * EXACT SAME S04 topology RNG as B0/MM/2RH.
         */
        val topologyRandom =
            Random(
                config.seed +
    ...
    fun runSeededCombinedScenario(
        ...
        require(
            ...
            "CARBLE S05 requires exactly 5 nodes."
        }
        ...
        val successProbability =
            requireNotNull(
                ...
                "CARBLE S05 requires successProbability."
            }
        ...
        val failureProbability =
            requireNotNull(
                ...
                "CARBLE S05 requires topologyFailureProbability."
            }
        ...
        require(
            ...
            "CARBLE S05 requires topologyDecisionTimes."
        }
        ...
        /*
         * EXACT SAME independent S05 streams as B0/MM/2RH.
         */
        val linkRandom =
            Random(
                config.seed +
    ...
    private data class CarbleContext(
    ...
    private fun createCarbleContext(
        config: ExperimentConfig,
        graph: Graph,
        ...
        /*
         * Same directed edge-observation initialization as
         * frozen MM and 2RH.
         */
        graph.getEdges()
            .forEach { edge ->
        ...
        /*
         * Same MM observation pipeline used by frozen MM
         * and 2RH.
         *
         * Primary attempts, retries, probes, and CARBLE
         * backup transmissions all contribute evidence
         * through this same instrumentation path.
         */
        val instrumentation =
            MMInstrumentation(
        ...
        /*
         * Frozen MM-v1.0 remains CARBLE's deterministic
        ...
        /*
         * CARBLE LOW intentionally uses the same bounded
    ...
    private fun createSimulator(
        ...
        /*
         * Preserve exact B0/MM/2RH behavior:
         *
    ...
    private fun scheduleSeededTraffic(
        ...
        /*
         * Preserve MM/B0/2RH fixed-interval behavior
         * whenever burst configuration is absent.
         */
        if (
    ...
    private fun validatePacketAccounting(
        ...
        require(
            ...
            "Invalid CARBLE run ${config.runId}: " +
    ...
    private fun validateTransmissionAccounting(
        ...
        require(
            ...
            "CARBLE transmission missing logicalHopIndex."
        }
        ...
        (_, attempts) in groups
            ...
            require(
                ...
                "Invalid CARBLE transmission attempt sequence: " +
                        "$actualNumbers"
            }
        }
    }
    ...
    private fun validateCrossStreamReconciliation(
        ...
        require(
            ...
            "CARBLE retransmission reconciliation failed."
        }
    ...
    private fun buildRunOutput(
        ...
        require(
            ...
            "CARBLE runner unexpectedly already contains resource samples."
        }
        ...
        /*
         * CARBLE exposes MM's common routing telemetry
         * through CarbleRouteProvider.telemetry.
         *
    ...
    private fun requireCarbleProtocol(
        config: ExperimentConfig
    ) {
        ...
        require(
            ...
            "CarbleExperimentRunner only runs protocol CARBLE. " +
